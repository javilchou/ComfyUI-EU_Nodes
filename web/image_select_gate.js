...
function ensureStyles() {
    ...
    style.textContent = `
        ...
        .eu-gate-grid{flex:1;overflow:auto;padding:16px;display:grid;grid-template-columns:repeat(auto-fill,minmax(180px,1fr));gap:12px;align-content:start}
        .eu-gate-card{position:relative;height:180px;border:3px solid transparent;border-radius:6px;overflow:hidden;background:#111;cursor:pointer;transition:border-color 120ms ease,transform 120ms ease}
